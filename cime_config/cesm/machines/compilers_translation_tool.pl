...
# All other elements.
my %non_flag_element = map {$_, 1} ("CONFIG_SHELL", "CPRE", "CXX_LINKER",
                         "ESMF_LIBDIR", "HAS_F2008_CONTIGUOUS", "HDF5_PATH",
                         "LAPACK_LIBDIR", "LD", "MPI_LIB_NAME", "MPI_PATH",
                         "MPICC", "MPICXX", "MPIFC", "NETCDF_PATH", "PAPI_INC",
                         "PAPI_LIB", "PFUNIT_PATH", "PIO_FILESYSTEM_HINTS",
                         "PNETCDF_PATH", "SCC", "SCXX", "SFC", "SUPPORTS_CXX",
                         "TRILINOS_PATH");
